import { getTaskByUpdateToken, updateTaskByToken, validTaskToken } from "../../../lib/supabase.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "PATCH") {
      if (!validTaskToken(token)) return res.status(404).json({ error: "Task not found" });
