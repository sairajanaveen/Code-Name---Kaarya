...
export const exampleOutput = {
  ...
  minutes: [
    { topic: "Pilot launch and onboarding", discussion: "The team reviewed readiness for the pilot. Onboarding must be completed before the launch; Asha will provide the checklist on 28 August.", outcome: "Launch the pilot after onboarding is complete." },
    { topic: "Dashboard loading", discussion: "The dashboard loading issue remains open. Rohan committed to fixing it by 29 August.", outcome: "Rohan owns the loading fix." },
    { topic: "Vendor documentation", discussion: "Priya cannot complete vendor setup until the GST documents arrive. The team has not agreed a completion date or identified who can release the documents.", outcome: "Resolve document ownership before the next review." }
  ],
  open_questions: ["Who can release the vendor GST documents?", "When can vendor setup be completed once the documents arrive?"],
  language: "en", readiness_score: 83,
