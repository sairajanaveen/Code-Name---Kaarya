...
export function normalizeIntakePayload(input = {}) {
  ...
  return {
    ...
    raw_notes: typeof (input.raw_notes || findValue(flat, "raw_notes")) === "string" ? (input.raw_notes || findValue(flat, "raw_notes")).trim() : "",
    ...
    output_focus: input.output_focus || "actions",
    review_before_send: input.review_before_send !== false,
    destination_channels: input.destination_channels || ["dashboard"]
  };
}
