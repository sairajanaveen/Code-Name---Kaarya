...
// Keep one structured-output pass comfortably inside the serverless request window.
// At 28k characters plus 1.8k overlap, an 8 MiB ASCII transcript remains below 350 checkpoints.
export const DIRECT_TRANSCRIPT_LENGTH = 28000;
