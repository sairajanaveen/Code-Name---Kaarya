...
export function groundOutput(result, transcript, attendees = "") {
  ...
  if (result.action_items.length && !action_items.length) throw new AppError("We could not verify the draft's source quotes. Your notes are unchanged. Please retry.", 502, "UNGROUNDED_OUTPUT");
